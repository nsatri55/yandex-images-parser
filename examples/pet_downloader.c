...
int main() {
    ...
    printf("Downloading 15 cat pictures...\n");
    yandex_session_t *cats = yandex_create_session("cats", 3);
    if (!cats) {
    ...
    if (yandex_download_image_range(cats, 0, 15, "cats") == YANDEX_SUCCESS) {
        printf("Downloaded 15 cat pictures\n");
    } else {
        printf("Failed to download cats\n");
    }
    
    yandex_free_session(cats);
    
    printf("\nDownloading 10 dog pictures...\n");
    ...
    if (yandex_download_image_range(dogs, 0, 10, "dogs") == YANDEX_SUCCESS) {
        printf("Downloaded 10 dog pictures\n");
    } else {
        printf("Failed to download dogs\n");
    }
    
    yandex_free_session(dogs);
    
    printf("\nDownload complete!\n");
    printf("Check the 'cats' and 'dogs' folders for your pictures.\n");
